(function($) {
	...
	//	<i class="dashboardicon animate-spin">&#xe801;</i>
		...
		if ('' !== card.front.image) {
			...
			card.front.text = '<img src="' + config.basePath + card.front.image + '" class="background"><div style="pointer-events: none;' + card.front.style + '">' + card.front.text + '</div>';
		} else {
	...
	$(document).ready(function () {
		...
		config.basePath = Drupal.settings.data_dashboard.basePath;
